// ============================================================
// test_refine_ft8_delay_v7_fixed.cpp
//
// FAST FT8 DELAY REFINEMENT V7 - DUAL PLATFORM
...
//
// V7:
//   coarse search +/- 100 ms, step 4 samples
//   fine search +/- 6 samples, step 1 sample
...
static float refine_ft8_delay_v7(
    const float* samples,
    int num_samples,
    const uint8_t* tones,
    float delay0,
    ...
    RefineTiming* timing = nullptr)
{
    ...
    static_assert(MAX_COARSE <= 601, "MAX_COARSE too small");
    (void)cand_to_print;
...
static void run_one_test(const char* filename, float true_delay)
{
    ...
    const float estimated_delay =
        refine_ft8_delay_v7(samples, num_samples, tones,
...
static void run_all_tests()
{
    printf("\r\n\r\n");
    printf("############################################################\n");
    printf(" FT8 refine_ft8_delay_v7 - REAL WAV BENCHMARK\n");
    printf("############################################################\n");
